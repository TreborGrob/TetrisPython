...
img_obj1 = PhotoImage(file="img/1.png")
sc.create_image(0, 0, anchor=NW, image=img_obj1)

img_obj2 = PhotoImage(file="img/1.png")
...
sc.create_text(505, 30, text="GHOUL", font=("WiGuru 2", 50), fill="red", anchor=NW)
sc.create_text(535, 780, text="score:", font=("WiGuru 2", 35), fill="red", anchor=NW)
_score = sc.create_text(550, 840, text=str(score), font=("WiGuru 2", 35), fill="white", anchor=NW)
sc.create_text(525, 650, text="record:", font=("WiGuru 2", 35), fill="red", anchor=NW)
_record = sc.create_text(550, 710, text=record, font=("WiGuru 2", 35), fill="white", anchor=NW)
